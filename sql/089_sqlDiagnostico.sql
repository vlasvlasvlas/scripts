...
USE [diagnosticoSQL]
GO
/****** Object:  Table [dbo].[diagnosticoSQL]    Script Date: 27/04/2020 8:14:26 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[diagnosticoSQL](
	...
	[base] [nvarchar](128) NULL,
	[consulta] [varchar](8000) NULL
) ON [PRIMARY]

GO
/****** Object:  StoredProcedure [dbo].[Recover_Modified_Data_Proc]    Script Date: 27/04/2020 8:14:26 a. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--GO
create PROCEDURE [dbo].[Recover_Modified_Data_Proc]
@Database_Name NVARCHAR(MAX),
@SchemaName_n_TableName NVARCHAR(MAX),
@Date_From DATE='01/02/2019',
@Date_To DATE  ='02/02/2019'
AS
